...
public class CSVData {
    /*
    Fields
    - Keeps a list of all category objects associated with this CSVData.
    - Keeps a list of all Item objects associated with this CSVData.
    ...
    /// Constructor
    public CSVData(){}
    public CSVData(String name, File file) throws Exception {
        System.out.println("Constructing CSVData: " + name);
        this.name = name;
        ...
        while (currentRow != null) {
            ...
            if (rowLength < 3){
                throw new Exception("The CSV file has less then 3 Columns it needs a name, rules and description roll");
            }
            else if (rowLength == 3){

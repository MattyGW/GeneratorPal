...
public class ActorOptions {
    ...
    //Constructor
    public ActorOptions(InterfaceManager interfaceManager){
...
//        mainBody.setAlignment(Pos.CENTER);
    ...
    public void display(String title, HashMap<String,Integer> categoriesNameWeight, HashMap<String, Object> selectedCategories) {
        ...
        while (iterator.hasNext()){
            ...
            String tagName = (String)mapElement.getKey();
            int tagWeight = (int)mapElement.getValue();
            ...
            textField.setText(String.valueOf(tagWeight));
